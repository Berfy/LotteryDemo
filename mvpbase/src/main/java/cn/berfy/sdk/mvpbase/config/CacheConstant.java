...
public class CacheConstant {
     ...
     * SharedPreference文件名
     */
    public static String XML_FILENAME = "zxpubg";
    ...
    public interface Live {
        /*-------------------------key-------------------------*/
        String KAY_DANMUKU_ALPHA = "live_danmaku_alpha";//直播间弹幕透明度
        String KEY_DANMUKU_SIZE = "live_danmaku_size";//直播间弹幕大小：1大-DANMUKU_SIZE_LARGE 2小-DANMUKU_SIZE_SMALL
        String KEY_SCREEN_LIGHTENESS = "live_screen_lighteness";//直播间屏幕亮度
        String KEY_DANMUKU_LOCATION = "live_danmaku_location";//直播间弹幕位置：1-顶部 2-底部 3-全屏
        String KEY_GESTURE_SWITCH = "live_gesture_switch";//直播间手势姿势开关

        String KEY_GAMBLE_ALERT_DIALOG = "live_gamble_alert_dialog";//直播间竞猜是否弹框提醒


        /*-------------------------常量-------------------------*/
        int DANMUKU_SIZE_LARGE = 17;
        int DANMUKU_SIZE_SMALL = 14;
    }
