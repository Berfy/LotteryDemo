...
public class ThreeDifferentOldFragment extends BaseFragment implements FastThreeSelectedListener, IBaseView, ILotteryOrderActivity {
                ...
                case MSG_SHOW_OPTION_BUTTON:
                    if (msg.obj != null && msg.obj instanceof List) {
                        ...
                        mAdapter = new ThreeDifferentAdapter(AppConstants.FAST_THREE_3_DIFFERENT,
                                btns, ThreeDifferentOldFragment.this);
    ...
    public static ThreeDifferentOldFragment newInstance(String lotteryType) {
        ThreeDifferentOldFragment fragment = new ThreeDifferentOldFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View threeSameSingleView = inflater.inflate(R.layout.fragment_three_different_old, container, false);
