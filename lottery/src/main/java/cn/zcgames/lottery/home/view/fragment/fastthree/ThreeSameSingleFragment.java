 ...
 * 2018.9.1
 */
public class ThreeSameSingleFragment extends BaseFragment implements FastThreeSelectedListener, IBaseView, ILotteryOrderActivity {
    ...
    public static ThreeSameSingleFragment newInstance(String lotteryType) {
        ThreeSameSingleFragment fragment = new ThreeSameSingleFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View threeSameSingleView = inflater.inflate(R.layout.fragment_three_same_single, container, false);
    ...
    private void showButton(List<LotteryBall> btns) {
        mAdapter = new ThreeSameSingleAdapter(AppConstants.FAST_THREE_2_SAME_ONE, btns, mContext, ThreeSameSingleFragment.this);
