 ...
 * 2018.8.23
 */
public class Arrange3DescriptionActivity extends BaseActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        UIHelper.hideSystemTitleBar(this);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lottery_arrange3_description);
        initView();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.title_back:
                goBack(Arrange3DescriptionActivity.this);
                break;
        }
    }
}
