...
import cn.zcgames.lottery.home.view.adapter.BankCardAdapter;

/**
 * Created by Administrator on 2016/8/16.
 */
public class BankCardLeftSwipeRv extends RecyclerView {
    ...
    public BankCardLeftSwipeRv(Context context) {
        this(context, null);
    }

    public BankCardLeftSwipeRv(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BankCardLeftSwipeRv(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mMenuState == MENU_CLOSED) {
                    ...
                    //获得这个view的ViewHolder
                    BankCardAdapter.BankViewHolder holder = (BankCardAdapter.BankViewHolder) getChildViewHolder(view);
                    //获得这个view的position
