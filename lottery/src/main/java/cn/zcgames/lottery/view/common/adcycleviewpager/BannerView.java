package cn.zcgames.lottery.view.common.adcycleviewpager;
...
public class BannerView extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private List<ADInfo> infos;//数据集合
    ...
    public void setData(List<ADInfo> list, ImageCycleViewListener listener,
        ...
        for (int i = 0; i < mIndicators.length; i++) {
            ...
            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                    ...
                    LinearLayout.LayoutParams.WRAP_CONTENT);
            lp.setMargins(UIHelper.dip2px(mContext, 0), 0, UIHelper.dip2px(mContext, 5), 0);
...
//        backGround.setBackgroundColor(Color.parseColor("#44222222"));
    ...
    private void setIndicator(int selectedPosition) {
        setText(mTitle, infos.get(selectedPosition).getTag());
        try {
            for (int i = 0; i < mIndicators.length; i++) {
